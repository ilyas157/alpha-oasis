...
const HomeCards = ({ destination }) => {
  const { title, description, location, country, duration, price, src } =
    destination;

  return (
    <div className=" bg-white h-full sm:w-full  shadow-2xl rounded-4xl overflow-hidden transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 ">
      <img
        src={src}
        alt={title}
