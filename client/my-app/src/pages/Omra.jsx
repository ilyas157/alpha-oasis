...
const Omra = () => {
  ...
  const data = useFilteredData('voyage', "omra_hajj",page, sort, setLoading);
  ...
  return (
    <>
      ...
      <main className="pt-[140px] bg-[#f3f0ed80]">
        ...
        <h1 className="text-5xl  text-center lg:pl-90 mb-12">Omra & Hajj</h1>
        {/*    
       <div className="flex  w-full gap-5 justify-center mb-5 "> */}
        ...
        <section className="flex max-w-[1500px] mx-auto mb-5">
          ...
          <div className="flex flex-grow flex-col justify-center ">
            ...
            <Pagination
              currentPage={page}
              numOfPages={Math.ceil(data.totale / 6)}
              changePage={(e) => {
