...
const ReservationPage = () => {
    ...
    préference_user: {
      hebergement: {
        room: {
          ...
          typeLit: 'single',
          prix: 300,
          roomID: '6890ca10244b91961a5343f7',
        },
      },
      transport: [],
      generale: '',
  ...
  const voyage = {
    ...
    cities: info?.villes || [],
    period: info?.période || '',
    price: info?.prix_basique || 0,
    duration: info?.durée,
    availableSpots: info?.nb_places,
    features: info?.inclus,
  };
  ...
  const submitReservation = () => {
    ...
    console. log( "date depart",data.etapes[0].trajet[0].depart.date_depart)
    try {
      ...
      const reservationData = {
        ...
        bookingInfo: {
          ...
          date_depart: data.etapes[0].trajet[0].depart.date_depart,
        },
  ...
  const calculateTotal = () => {
    return voyage.price * formData.nb_personne;
  };
      ...
      <div className="pt-[145px] min-h-screen   bg-[#f3f0ed80]">
        <main className="container mx-auto max-w-7xl  px-4 py-8">
          ...
          <div className="mb-8">
            ...
            <div className="bg-yellow-400/10 xl:w-[1300px] border-1 border-amber-100 rounded-4xl">
              <div className="p-6">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                  <div>
                    <h2 className="text-2xl font-bold  mb-2">{voyage.title}</h2>
                    <div className="flex flex-wrap gap-4 ">
                      <div className="flex items-center gap-2">
                        <MapPin className="h-4 w-4" />
                        <span>{voyage.cities.join(', ')}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <Calendar className="h-4 w-4" />
                        <span>{voyage.period}</span>
                      </div>
                      <div className="flex items-center gap-2">
                  ...
                  <div className="text-right">
                    <div className="text-3xl font-bold text-primary">
                      {voyage.price.toLocaleString('fr-FR')} DH
                    </div>
                    <div className="text-muted-foreground">par personne</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 ">
            ...
            <div className="lg:col-span-1">
              <div className="sticky flex-col gap-5 flex top-4 xl:w-md bg-white p-5 rounded-4xl">
                ...
                <h3 className="font-semibold">{voyage.title}</h3>
                <p className="text-sm text-muted-foreground">
                  {voyage.cities.join(', ')}
                </p>
                ...
                <div className="flex justify-between">
                  ...
                  <span>{voyage.price.toLocaleString('fr-FR')} DH</span>
                </div>
                ...
                <div className="bg-blue-50 p-3 rounded-lg">
                  ...
                  <ul className="text-xs space-y-1">
                    {voyage.features.map((feature, index) => (
