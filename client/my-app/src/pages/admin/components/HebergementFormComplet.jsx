  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        'http://localhost:5000/api/hebergement',
        hebergementForm,
        { headers: { 'Content-Type': 'application/json' } }
      );
      alert('Hébergement créé:', response.data);
...
export default HebergementFormComplet;
            ...
            <div className="border-dashed">
              <div className="pt-4">
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div>
                    <label className="text-sm">Type de lit</label>
                    <Select>
                      <SelectTrigger>
                        <SelectValue placeholder="Un lit" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="single">Un lit simple</SelectItem>
                        <SelectItem value="double">Un lit double</SelectItem>
                        <SelectItem value="twin">Deux lits simples</SelectItem>
                        <SelectItem value="king">Lit king size</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div>
                    <label className="text-sm">Prix (DH/nuit)</label>
                    <input className="input" type="number" placeholder="500" />
                  </div>
                </div>
              </div>
            </div>
            <button className="btn w-full" onClick={addRoom}>
